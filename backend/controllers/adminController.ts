...
// // Block a doctor
// const blockDoctor = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
//   const { doctorId } = req.params;
//   try {
...
// // Unblock a doctor
// const unblockDoctor = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
//   const { doctorId } = req.params;
//   try {
...
// // Fetch all doctors
// const fetchAllDoctors = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
//   try {
...
// const rejectDoctor = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
//   const { doctorId } = req.params;
...
// const updatePlatformFee = async (req: Request, res: Response): Promise<Response> => {
...
// const TopRevenueDoctors = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
//   try {
...
// const getTopRatedDoctors = async (req: Request, res: Response): Promise<Response> => {
...
// const getTopPatients = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
//   try {
//     const page = parseInt(req.query.page as string, 10) || 1;
//     const limit = parseInt(req.query.limit as string, 10) || 10;
...
// const getTopBookedDoctors = async (req: Request, res: Response) => {
...
// // Controller
// const getSpecializationsPieChart = async (req: Request, res: Response) => {
//   try {
...
// const getDoctorsRevenueBarChart = async (req: Request, res: Response) => {
//   try {
...
// deletePatient,blockDoctor, unblockDoctor,fetchAllDoctors,fetchDoctorProfile,rejectDoctor,updatePlatformFee,
// TopRevenueDoctors,getTopRatedDoctors,getTopPatients,getTopBookedDoctors,getSpecializationsPieChart,
// getDoctorsRevenueBarChart,getReport
//  };
