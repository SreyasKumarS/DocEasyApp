...
class PatientService {
    ...
    async googleLogin(googleToken, res) {
        try {
    ...
    patientId, totalAmount, adminFee, consultationFee // Accepting totalAmount from the frontend
    ) {
        try {
    ...
    async cancelAndRefund(slotId, patientId, amount, startTime) {
        try {
    ...
    async createWalletRechargeOrder(patientId, amount) {
        try {
    ...
    async submitReview(doctorId, patientName, comment, rating) {
        try {
