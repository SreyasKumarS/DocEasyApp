...
import {PatientProfileScreenPatientData} from '../../../interfaces/patientInterfaces'




const PatientProfile = () => {
  const [patientData, setPatientData] = useState<PatientProfileScreenPatientData | null>(null);
    ...
    <div className="d-flex">
      <Container className="py-5 flex-grow-1 d-flex justify-content-center">
        <Card className="shadow-lg" style={{ width: '100%', maxWidth: '900px', borderRadius: '15px', padding: '20px' }}>
          <Card.Header className="text-center bg-primary text-white fw-bold" style={{ fontSize: '1.3rem', borderTopLeftRadius: '15px', borderTopRightRadius: '15px' }}>
            <p className="mb-1"><small>User Profile</small></p>
          </Card.Header>
          ...
          <Card.Body>
            ...
            <Row>
              ...
              <Col style={{ fontSize: '1.1rem' }}>{patientData. locality}</Col>
            </Row>
            <Row>
              <Col xs={4} className="text-secondary text-end" style={{ fontSize: '1.1rem' }}>
                <BsPhone /> Contact:
          ...
          <Card.Footer className="text-center">
            <Button variant="primary" className="me-2" onClick={() => navigate('/patient/EditPatientProfile')}>
              Edit Profile
            </Button>
            <Button variant="secondary" onClick={() => navigate('/patient/HomeScreen')}>
              Back
            </Button>
          </Card.Footer>
        </Card>
